defmodule HacksawTvWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HacksawTvWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HacksawTvWeb.Gettext, "errors", msg, opts)
    end
  end
